...
from .views import register_user, login_user, list_exams,create_exam, get_exam_details, submit_answers, list_users,get_student_exams,get_exam_score, send_otp,verify_otp,send_reset_otp, verify_reset_otp, reset_password, submit_contact
